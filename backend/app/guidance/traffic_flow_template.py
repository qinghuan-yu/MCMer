    ...
    for fit in fits:
        for sample_index, label in sample_labels:
            ...
            rows.append({
                ...
                "answer_item": f"{label} 主路聚合拟合值（给定基函数）",
                "answer": f"{value:.6g}",
        ...
        "rows": [
            {
                ...
                "answer_item": "设计矩阵 A_S",
                "answer": "用当前选定的分段、相位和延迟基函数，在候选观测集合 S 上构造设计矩阵 A_S。",
                "status": "candidate_design",
                "evidence_ids": ["param_problem5_monitoring_times"],
            },
            {
                "subproblem_id": "problem5",
                "answer_item": "rank(A_S)",
                "answer": f"rank(A_S)={design_rank}",
                "status": "candidate_design",
                "evidence_ids": ["param_problem5_design_rank"],
            },
            {
                "subproblem_id": "problem5",
                "answer_item": "dim(theta)",
                "answer": f"dim(theta)={parameter_dimension}",
                "status": "candidate_design",
                "evidence_ids": ["param_problem5_parameter_dimension"],
            },
            {
                "subproblem_id": "problem5",
                "answer_item": "最小性边界",
                "answer": f"rank(A_S)<dim(theta)，rank gap={rank_gap}；因此当前观测时刻只能称候选设计，未证明全局最少。",
                "status": "candidate_design",
                "evidence_ids": ["param_problem5_rank_gap"],
            },
        ],
        "notes": [
        ...
        "summary": {
            ...
            "reader_decision_guide": [
                ...
                },
                {
                    "topic": "route_choice",
                    "question": "推荐路线/排除路线",
                    "judgment": "推荐问题1采用解族分析加规范化代表解而非唯一真值，问题2到问题4采用给定基函数回归与残差披露；排除把支路分解写成唯一真值。",
                    "action": "避免堆模型名；把推荐与排除理由、基函数、参数向量、约束、求解器和误差指标写清楚。",
                },
                {
                    "topic": "final_answers",
                    "question": "最终可填内容",
                    "judgment": "可填写规范化代表函数、候选观测时刻、指定时刻主路聚合拟合值；支路唯一流量不可直接填写为真值。",
                    "action": "引用最终答案表，所有数值必须绑定具体 result_ 或 param_ 证据 ID。",
                },
                {
                    "topic": "claim_sources",
                    "question": "结论来源分层",
            ...
            "method_route_comparison": [
                {
                    ...
                    "evidence_ids": ["claim_problem1_branch_split"],
                },
                {
                    "route": "黑箱曲线拟合",
                    "status": "rejected",
                    ...
                    "evidence_ids": ["claim_problem2_to_4_fit"],
                },
                {
                    "route": "EM/MCMC 噪声模型",
                    "status": "rejected",
            ...
            "identifiability_analysis": [
                {
                    ...
                    "conclusion": "不可唯一识别；设 a_1=lambda, a_2=1.5-lambda，可在约束允许范围内得到一族完全复原 F(k) 的支路分解。",
                    "missing_information": "缺少支路传感器、边界流量或其他独立约束。",
                ...
                },
                {
                    ...
                    "conclusion": "当前候选集合尚未完成最小性证明；如果任意 S 下 A_S 仍列相关，则仅靠主路设备不能唯一恢复支路函数。",
                    "missing_information": "缺少达到参数维数下界的满秩采样集合证明，或额外支路传感器与独立先验。",
            ...
            "claim_registry": [
                {
                    ...
                    "evidence_ids": ["result_problem1_traffic_fit", "param_problem1_break_t"],
                ...
                },
                {
                    ...
                    "evidence_ids": ["param_problem2_delay"],
                ...
                },
                {
                    ...
                    "evidence_ids": ["result_problem5_minimum_monitoring", "param_problem5_monitoring_times"],
            ...
            "final_answer_tables": [
                {
                    ...
                    "rows": [
                        {
                            "subproblem_id": "problem1",
                            "answer_item": "支路1车流量函数",
                            "answer": "f_1(k)=7+0.5k",
                            "status": "chosen_under_prior",
                            "evidence_ids": ["param_problem1_intercept", "param_problem1_direct_slope"],
                        },
                        {
                            "subproblem_id": "problem1",
                            "answer_item": "支路2车流量函数",
                            "answer": "f_2(k)=k, 0<=k<=30; f_2(k)=60-k, 30<k<=59",
                            "status": "chosen_under_prior",
                            "evidence_ids": ["param_problem1_triangular_slope", "param_problem1_break_t"],
                        },
                    ],
                    "notes": [
                    ...
                    "rows": [
                        {
                            ...
                            "answer": "20",
                            "status": "candidate_design",
                            "evidence_ids": ["result_problem5_minimum_monitoring", "param_problem5_monitoring_count"],
                        },
                        {
                            "subproblem_id": "problem5",
                            "answer_item": "样本序号集合",
                            "answer": "0, 1, 3, 7, 10, 12, 16, 21, 24, 25, 30, 34, 37, 39, 43, 45, 48, 52, 57, 59",
                            "status": "candidate_design",
                            "evidence_ids": ["result_problem5_minimum_monitoring", "param_problem5_monitoring_times"],
                        },
                    ],
