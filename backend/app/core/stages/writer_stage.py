...
class WriterStage:
    ...
    def context_contract_text() -> str:
        ...
        return (
            ...
            "the figure caption; describe only the labeled numeric values visible "
            "in that overview, place it near the result table or result analysis it supports, "
            "and never relabel it as fitting_curve, residual_plot, "
            "comparison_bar, mechanism, workflow, or a model-shape/curve figure. If "
