    ...
    async def clear_memory(self):
        ...
        try:
            ...
            if end_idx > start_idx:
                ...
                for msg in self.chat_history[start_idx:end_idx]:
                ...
                summary_messages = [
                    {
                        "role": "system",
                        "content": "你是一个对话总结助手，请简洁准确地总结。",
                    },
                    {"role": "user", "content": summary_prompt},
                ]

                # 调用 simple_chat 进行总结
                summary = await simple_chat(summary_messages, max_tokens=512)
                ic(f"总结结果: {summary[:200]}...")
